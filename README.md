...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pythonds-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13275&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pythonds-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pythonds` can be installed with:

```
conda install pythonds
```

It is possible to list all of the versions of `pythonds` available on your platform with:
